...
move /Y BaseSys.sym ..\bin3\
move /Y Crypt.sym ..\bin3\
move /Y Base1.sym ..\bin3\
move /Y Scanner1.sym ..\bin3\
move /Y Generator1.sym ..\bin3\
move /Y Parser1.sym ..\bin3\
move /Y AyaCompile1.sym ..\bin3\
echo on